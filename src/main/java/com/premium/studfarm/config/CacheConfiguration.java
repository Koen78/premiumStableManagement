package com.premium.studfarm.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("premiumStableManagement");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("premiumStableManagement");
        ...
        config.getMapConfigs().put("com.premium.studfarm.domain.*", initializeDomainMapConfig(jHipsterProperties));
